...
<div class="page">
    ...
    <form method="post" enctype="multipart/form-data" id="user_form">
        ...
        <table class="table tb-type2">
			...
			<div style="display: none;" class="type-file-preview"><img id="view_img" src="${S_URL}/att?path=${P_MEMBER.memberAvatar}"></div>
			</span>
...
<script src="${S_COMMON_URL}/scripts/jquery/jquery.Jcrop.js" type="text/javascript"></script>
<link id="cssfile2" type="text/css" rel="stylesheet" href="${S_COMMON_URL}/scripts/jquery/jquery.Jcrop.css">
<script type="text/javascript">
    //裁剪图片后返回接收函数
    function call_back(picname){
        $('#memberAvatar').val(picname);
        $('#view_img').attr('src','http://localhost/shopnc/data/upload/shop/avatar/'+picname+'?'+Math.random());
    }
    $(function(){
