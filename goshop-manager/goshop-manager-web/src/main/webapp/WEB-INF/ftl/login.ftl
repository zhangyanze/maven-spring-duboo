...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <script src="${S_COMMON_URL}/scripts/shop/common.js" type="text/javascript"></script>
    <script src="${S_COMMON_URL}/scripts/jquery/jquery.tscookie.js" type="text/javascript"></script>
...
<div class="bottom">
    ...
    <h6 title="四川省攀枝花市托日有限责任公司">&copy; 2015-2016 <a target="_blank" href="#"></a></h6>
</div>
