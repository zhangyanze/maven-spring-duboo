...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>文章管理</h3>
            <ul class="tab-base">
                <li><a <#if RequestParameters['article_state']??><#if RequestParameters['article_state']=='3'>class="current"</#if><#else>class="current"</#if> href="${S_URL}/article_lang/article_list"><span>列表</span></a></li>
    ...
    <form name="formSearch" method="get">
        <input type="hidden" name="act" value="article_lang">
        ...
        <table class="tb-type1 noborder search">
            ...
            <tr style="background: rgb(255, 255, 255) none repeat scroll 0% 0%;">
                ...
                <td><select name="article_state">
                    ...
                    <#list P_ARTICLE_CLASS_LIST as aClass>
        ...
        <table class="table tb-type2">
            ...
            <tr class="hover edit" style="background: rgb(255, 255, 255) none repeat scroll 0% 0%;">
                ...
                <td><p>作者： <#list o.articleLangInfoList as info>${info.articleAuthor}&nbsp</#list>
                    </p><p>发布日期：${o.articlePublishTime?string("yyyy-MM-dd")}</p>
                    </td>
                ...
                <td class="w84"> <#list P_ARTICLE_CLASS_LIST as aClass>
